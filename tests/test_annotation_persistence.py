...
def test_features_persisten_entre_managers(qgis_app, crs, gpkg_path, proyecto_limpio):
    ...
    # El tercer feature lo dejamos en pending: no necesitamos su id porque
    # no le aplicamos ninguna transición. Usamos _ para callar flake8 F841.
    _ = mgr_a.agregar_anotacion(_polygon_dummy())
